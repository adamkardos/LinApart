...
* coefficient matrix, entry (6,81).  Runs the determinant branch.
*
...
*   tform -w16 entry_06_081_det.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (6,81) determinant: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (6,81) determinant (NumDiff = 0)
print +ss;
.end
