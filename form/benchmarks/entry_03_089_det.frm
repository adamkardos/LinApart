...
* coefficient matrix, entry (3,89).  Runs the determinant branch.
*
* INPUT SOURCE (the rational function below is entry (3,89) of the
...
*
* ENTRY STRUCTURE: 11 distinct linear denominators, maximum
* multiplicity 3 (benchmark power index sum_m = 18).
*
...
*   determinant branch : 1.59 s  (Phase 1 1.00 s, Phase 2 0.53 s)
*   cover-first cache   : 0.53 s  (Phase 1 0.17 s, Phase 2 0.33 s)
...
*   tform -w16 entry_03_089_det.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (3,89) determinant: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (3,89) determinant (NumDiff = 0)
print +ss;
.end
