...
* coefficient matrix, entry (17,27).  Runs the determinant branch.
*
...
*   tform -w16 entry_17_027_det.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (17,27) determinant: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (17,27) determinant (NumDiff = 0)
print +ss;
.end
