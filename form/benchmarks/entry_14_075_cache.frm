...
* coefficient matrix, entry (14,75).  Runs the cover-first cache branch.
*
...
*   tform -w16 entry_14_075_cache.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (14,75) cover-first cache: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (14,75) cover-first cache (NumDiff = 0)
print +ss;
.end
