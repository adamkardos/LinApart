...
* coefficient matrix, entry (12,22).  Runs the cover-first cache branch.
*
* INPUT SOURCE (the rational function below is entry (12,22) of the
...
*
* ENTRY STRUCTURE: 9 distinct linear denominators, maximum
* multiplicity 2 (benchmark power index sum_m = 12).
*
...
*   determinant branch : 0.06 s  (Phase 1 0.03 s, Phase 2 0.02 s)
*   cover-first cache   : 0.07 s  (Phase 1 0.03 s, Phase 2 0.02 s)
...
*   tform -w16 entry_12_022_cache.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (12,22) cover-first cache: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (12,22) cover-first cache (NumDiff = 0)
print +ss;
.end
