...
* coefficient matrix, entry (12,22).  Runs the determinant branch.
*
...
*   tform -w16 entry_12_022_det.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (12,22) determinant: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (12,22) determinant (NumDiff = 0)
print +ss;
.end
