...
* coefficient matrix, entry (5,82).  Runs the determinant branch.
*
...
*   tform -w16 entry_05_082_det.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (5,82) determinant: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (5,82) determinant (NumDiff = 0)
print +ss;
.end
