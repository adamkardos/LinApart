...
* coefficient matrix, entry (3,89).  Runs the cover-first cache branch.
*
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (3,89) cover-first cache: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (3,89) cover-first cache (NumDiff = 0)
print +ss;
.end
