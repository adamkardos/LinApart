...
* coefficient matrix, entry (17,27).  Runs the cover-first cache branch.
*
* INPUT SOURCE (the rational function below is entry (17,27) of the
...
*
* ENTRY STRUCTURE: 2 distinct linear denominators, maximum
* multiplicity 1 (benchmark power index sum_m = 3).
*
...
*   determinant branch : 0.01 s  (Phase 1 0.00 s, Phase 2 0.01 s)
*   cover-first cache   : 0.02 s  (Phase 1 0.01 s, Phase 2 0.00 s)
...
*   tform -w16 entry_17_027_cache.frm
...
#if ( `$residual' != 0 )
  #message ROUNDTRIP FAILED -- dpentagon entry (17,27) cover-first cache: NumDiff has `$residual' surviving term(s)
  #terminate
#endif
#message ROUNDTRIP OK -- dpentagon entry (17,27) cover-first cache (NumDiff = 0)
print +ss;
.end
